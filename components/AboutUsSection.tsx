    ...
    <section id="about-us" className="about-us-section relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            ...
            <div className="hidden lg:block lg:col-span-1">
              <div className="relative aspect-[2/3] max-w-[200px] mx-auto">
                <LazyImage
                  ...
                  fill
                  className="object-cover rounded-lg fade-on-scroll"
            ...
            <div className="lg:col-span-3 text-center space-y-6 fade-in-on-load relative">
              {/* Decorative Dots */}
              <div className="absolute left-0 top-1/2 -translate-y-1/2 hidden lg:block fade-on-scroll" aria-hidden="true">
              ...
              {/* Subtitle */}
              <p className="fade-on-scroll about-us-subtitle text-hero-light text-sm lg:text-base uppercase tracking-wider">
                About Us
              </p>

              {/* Headline */}
              <h2 className="fade-on-scroll about-us-headline text-white">
                Expertise, combined with quality:<br />
                The essence of beauty.
              </h2>

              {/* Description */}
              <p className="fade-on-scroll about-us-description text-white/90 max-w-3xl mx-auto">
            ...
            <div className="hidden lg:block lg:col-span-1">
              <div className="relative aspect-[2/3] max-w-[200px] mx-auto">
                <LazyImage
                  ...
                  fill
                  className="fade-on-scroll object-cover rounded-lg"
                  sizes="(max-width: 1024px) 0vw, 200px"
                />
              </div>
            </div>
      ...
      <div className="about-us-bottom bg-[#1a1a1a] py-16 lg:py-20 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 fade-on-scroll">
          ...
          {/* Main Title */}
          <h3 className="fade-on-scroll about-us-treatment-title text-white mb-8 lg:mb-12 fade-in-on-load">
            Why Choose Our Home Beauty Services?
          </h3> 

          {/* Service Feature Tabs */}
          <div className="fade-on-scroll flex flex-wrap gap-3 lg:gap-4 mb-12 ">
            {serviceFeatures.map((feature) => (
              ...
              >
                <span className="fade-on-scroll text-xs lg:text-sm whitespace-nowrap">{feature.name}</span>
              </button>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="fade-on-scroll treatment-description fade-in-on-load">
            ...
            <div className="treatment-effects fade-in-on-load">
              <h4 className="fade-on-scroll text-white text-xl lg:text-2xl font-semibold mb-6">
                What You Get:
              </h4>
              <ul className="space-y-3">
                {serviceBenefits.map((benefit, index) => (
                  <li key={index} className=" fade-on-scroll flex items-start gap-3">
